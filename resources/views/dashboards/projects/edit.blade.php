        ...
        <form action="{{ route('dashboard.project.update', $project->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="space-y-4">
                <div class="pb-8 border-gray-900/10">
                    <h2 class="font-semibold text-gray-900 text-base/7">Edit Project</h2>
                    <p class="mt-1 text-gray-600 text-sm/6">Tambahkan projectnya entah sudah selesai ataupun belum selesai.
                    </p>
                            ...
                            <div class="mt-2">
                                <div
                                    ...
                                    <input type="text" name="type" id="type"
                                        ...
                                        placeholder="Personal" value="{{ $project->type }}">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="mt-2">
                                <div
                                    ...
                                    <input type="text" name="name" id="name"
                                        class="block min-w-0 grow py-1.5 pl-1 pr-3 text-base text-gray-900 placeholder:text-gray-400 focus:outline focus:outline-0 sm:text-sm/6"
                                        placeholder="ZV-E10" value="{{ $project->name }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="sm:col-span-full md:col-span-4">
                            ...
                            <div class="mt-2">
                                <textarea name="description" id="about" rows="4"
                                    class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">{{ $project->description }}</textarea>
                            </div>
                            ...
                            <div class="mt-2">
                                <div
                                    ...
                                    <input type="text" name="link" id="link"
                                        class="block min-w-0 grow py-1.5 pl-1 pr-3 text-base text-gray-900 placeholder:text-gray-400 focus:outline focus:outline-0 sm:text-sm/6"
                                        placeholder="https://instagram.com/syahreza_satria/" value="{{ $project->link }}">
                                </div>
                            </div>
                        </div>
                    </div>
