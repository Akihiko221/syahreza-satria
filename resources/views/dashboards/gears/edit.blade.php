        ...
        <form action="{{ route('dashboard.gear.update', $gear->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="space-y-4">
                <div class="pb-8 border-gray-900/10">
                    <h2 class="font-semibold text-gray-900 text-base/7">Edit Gear</h2>
                    <p class="mt-1 text-gray-600 text-sm/6">Gear yang digunakan untuk proses kreativitas.</p>

                    <div class="grid grid-cols-1 mt-10 gap-x-6 gap-y-8 sm:grid-cols-6">
                        {{-- Brand --}}
                        <div class="sm:col-span-full md:col-span-2">
                            <label for="brand" class="block font-medium text-gray-900 text-sm/6">Brand</label>
                            <div class="mt-2">
                                <div
                                    ...
                                    <input type="text" name="brand" id="brand"
                                        ...
                                        placeholder="Sony" value="{{ $gear->brand }}">
                                </div>
                            </div>
                        </div>
                        ...
                        {{-- Model --}}
                        <div class="sm:col-span-full md:col-span-2">
                            <label for="name" class="block font-medium text-gray-900 text-sm/6">Model</label>
                            <div class="mt-2">
                                <div
                                    class="flex items-center pl-3 bg-white rounded-md outline outline-1 -outline-offset-1 outline-gray-300 focus-within:outline focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-indigo-600">
                                    <div class="text-base text-gray-500 select-none shrink-0 sm:text-sm/6">
                                    ...
                                    <input type="text" name="name" id="name"
                                        class="block min-w-0 grow py-1.5 pl-1 pr-3 text-base text-gray-900 placeholder:text-gray-400 focus:outline focus:outline-0 sm:text-sm/6"
                                        placeholder="ZV-E10" value="{{ $gear->name }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="sm:col-span-full md:col-span-4">
                            ...
                            <div class="mt-2">
                                <textarea name="description" id="about" rows="4"
                                    class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">{{ $gear->description }}</textarea>
                            </div>
                        ...
                        <div class="sm:col-span-full md:col-span-4">
                            ...
                            <div class="flex items-center mt-2 gap-x-3">
                                @if ($gear->image)
                                    <img src="{{ asset('images/gear/' . $gear->image) }}"
                                        alt="{{ $gear->brand }} {{ $gear->name }}" width="100"
                            ...
                            <div class="mt-2">
                                <div
                                    ...
                                    <input type="text" name="link" id="link"
                                        class="block min-w-0 grow py-1.5 pl-1 pr-3 text-base text-gray-900 placeholder:text-gray-400 focus:outline focus:outline-0 sm:text-sm/6"
                                        placeholder="https://instagram.com/syahreza_satria/" value="{{ $gear->link }}">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="flex items-center justify-end mt-6 gap-x-6">
                <a href="{{ route('dashboard.gear') }}" class="font-semibold text-gray-900 text-sm/6">Cancel</a>
                <button type="submit"
